// not-cute kernel builder: sm80_gemm arch=SM80
...
module {
  gpu.module @notcute_kernels {
    gpu.func @sm80_gemm_kernel(%a_in: !memref_tile, %b_in: !memref_tile, %c_in: !memref_tile, %d_out: !memref_tile, %coord: !coord_zero) kernel {
