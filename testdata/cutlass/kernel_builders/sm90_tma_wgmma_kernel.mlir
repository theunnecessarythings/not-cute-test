// not-cute kernel builder: sm90_tma_wgmma arch=SM90
...
module {
  gpu.module @notcute_kernels {
    gpu.func @sm90_tma_wgmma_kernel(%a_in: !memref_tile, %b_in: !memref_tile, %c_in: !memref_tile, %d_out: !memref_tile, %coord: !coord_zero) kernel {
