// not-cute kernel builder: sm100_tcgen05 arch=SM100
...
module {
  gpu.module @notcute_kernels {
    gpu.func @sm100_tcgen05_kernel(%a_in: !memref_tile, %b_in: !memref_tile, %c_in: !memref_tile, %d_out: !memref_tile, %coord: !coord_zero) kernel {
